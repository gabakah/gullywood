 ...
 * such as their password, userEmail address, etc. Their
 ...
 * account information, with the current userEmail address
...
<tr>
<td>userEmail:</td>
<td><input type="text" name="userEmail" maxlength="50" value="
<?
if($form->value("userEmail") == ""){
   echo $session->userinfo['userEmail'];
}else{
   echo $form->value("userEmail");
}
?>">
</td>
<td><? echo $form->error("userEmail"); ?></td>
</tr>
