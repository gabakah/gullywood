...
?>
<?php
	// Get the values passed from the Register page.
	$email = NULL;
	$lastName = NULL;
	$firstName = NULL;		
...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body leftmargin="0" marginheight="0" marginwidth="0" topmargin="0">
		...
		<div style="position:relative;width:1029px;height:885px;-adbe-g:p,10,10;">
			<div style="position:absolute;top:140px;left:380px;width:357px;height:22px;">
				<label>Congratulations <?php echo $fname ?> <?php echo $lname ?>, a confirmation email has been sent to: <?php echo $email ?></label></div>
		</div>
		<div id="content">
