...
function show_register_form()
{
	...
	echo "				<label><a href=\"#\" onClick=\"return formValidatorStep1()\">Next &gt;&gt;</a></label>";
	echo "				<br />";
	echo "				<br />";
	echo "		</div>";
	echo "		<div id=\"rgStep2\">";
	...
	echo "		<input class=\"step2CheckBox\" type=\"checkbox\" name=\"checkboxName\" value=\"checkboxValue\" /><label for=\"step2BillingMailingAddress\" class=\"step2BillingMailingAddress\">My Billing Address is the same as my Mailing Address</label><br />";
...
if (isset($_POST['rgSubmitButton']))
{
	...
	$html .= "You have just registered with Gullywood.com, the premier African Movie Rental Site.\n";
	$html .= "The following is your login information:\n";
	$html .= "Username: " . $user . "\n";
	$html .= "Password: " . $password . "\n";
	$html .= "	To confirm this change and activate your new password please follow this link to our website: <a href=\"" . APPLICATION_URL . "confirm.php?memberName=$user&key=$randomKey \">" . APPLICATION_URL . "confirm.php?memberName=$user&key=$randomKey</a> .\n";
	...
	<body leftmargin="0" marginheight="0" marginwidth="0" topmargin="0">
		...
		<div id="mainmenu">
			<ul>
				...
				<li><a href="http://www.gullywood.com/gw/Queue.php?movieId=0&rmQueue=">Queue</a></li>
