<?
	...
	class db {
		...
		{
//			$sdbc = mysql_connect("localhost", "gabakah_admin", "supp0rt");
//			$db_selected = mysql_select_db("gabakah_gwdb", $sdbc);
			
			//$this->result = @mysql_query($query,$this->dbh);
//			$result = mysql_query($query, $sdbc);
			// return mysql_num_rows ( mysql_query ( $query ) );
			//return mysql_num_rows ( mysql_query ( $query,$this->dbh ),$this->dbh );
//			return mysql_num_rows ($result, $sdbc);
//			echo $result;
//			return $this->result; //mysql_num_rows ($this->result);
//			$rowcount = @mysql_fetch_object($this->result);
//			if (($rowcount) == 1)
//			{
//				return 1;
//			} else {
...
//		function getRow($query=null,$y=0,$output=OBJECT)
		function getRow($query,$y=0,$output=OBJECT)
		{
